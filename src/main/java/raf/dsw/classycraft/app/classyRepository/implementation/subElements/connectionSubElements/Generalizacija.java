...
{
    public Generalizacija(ClassyNode parent, String name)
    {
        super(parent, name);
        this.type = "Generalizacija";
    }

    public Generalizacija(ClassyNode parent, String name, InterClass fromElement, int x, int y)
    {
